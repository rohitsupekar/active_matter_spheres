...
def advection(S,m,params):
    ...
    # (+,+)
    L00 = -2*S.op[(m,2)]['k-'].dot(
                ( e0*S.op[(m,2)]['I'] + e1*( S.op[(m,1)]['k+'].dot(S.op[(m,2)]['k-'])
                                            +S.op[(m,3)]['k-'].dot(S.op[(m,2)]['k+']))
                                      + e2*( S.op[(m,1)]['k+'].dot(S.op[(m,2)]['k-'])
                                            +S.op[(m,3)]['k-'].dot(S.op[(m,2)]['k+'])).dot
                                           ( S.op[(m,1)]['k+'].dot(S.op[(m,2)]['k-'])
                                            +S.op[(m,3)]['k-'].dot(S.op[(m,2)]['k+']))
                                                                                      ).dot(S.op[(m,1)]['k+']) )
    ...
    # (-,-)
    L11 = -2*S.op[(m,-2)]['k+'].dot(
                ( e0*S.op[(m,-2)]['I'] + e1*( S.op[(m,-3)]['k+'].dot(S.op[(m,-2)]['k-'])
                                             +S.op[(m,-1)]['k-'].dot(S.op[(m,-2)]['k+']))
                                       + e2*( S.op[(m,-3)]['k+'].dot(S.op[(m,-2)]['k-'])
                                             +S.op[(m,-1)]['k-'].dot(S.op[(m,-2)]['k+'])).dot
                                            ( S.op[(m,-3)]['k+'].dot(S.op[(m,-2)]['k-'])
                                             +S.op[(m,-1)]['k-'].dot(S.op[(m,-2)]['k+']))
                                                                                      ).dot(S.op[(m,-1)]['k-']) )
